...
const (
	HealthService_HealthCheck_FullMethodName = "/crea.users.v1.HealthService/HealthCheck"
)
...
func (c *healthServiceClient) HealthCheck(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedHealthServiceServer) HealthCheck(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "crea.users.v1.HealthService",
	...
	Metadata: "crea/ms-users/v1/health.proto",
}
